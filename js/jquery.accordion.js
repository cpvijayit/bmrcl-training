    ...
    $.Accordion.prototype = {
        ...
        _initEvents: function() {
            ...
            this.$items.find("a:first").bind("click.accordion", function(event) {
                ...
                if (
                    instance.options.oneOpenedItem &&
                    instance._isOpened() &&
            ...
            $(window).bind("smartresize.accordion", function(event) {
                ...
                instance.$el.find("li.st-open").each(function() {
                    ...
                    $this.css(
                        ...
                        $this.find("div.st-content").outerHeight(true)
                    );
                });
        ...
        _scroll: function(instance) {
            ...
            instance.current !== -1 ?
                ...
                (current = instance.$el.find("li.st-open:last").index());

            $("html, body")
                .stop()
                .animate({
                        scrollTop: instance.options.oneOpenedItem ?
                            instance.$items.eq(current).data("offsetTop") - 100 :
                            instance.$items.eq(current).offset().top - 100
                    },
    ...
    $.fn.accordion = function(options) {
        if (typeof options === "string") {
            ...
            this.each(function() {
                ...
                if (!instance) {
                    logError(
                        "cannot call methods on accordion prior to initialization; " +
